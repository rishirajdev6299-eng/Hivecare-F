...
function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // IMPORTANT:
      //
      // NOW ASK BACKEND / MYSQL FOR CURRENT USER
      // =================================================
...
if (role === "WORKER") {
  console.log("REDIRECTING WORKER TO /worker");
      ...
      <div className="hive-login-wrapper">
        ...
        <div className="hive-login-card">
          ...
          {errorMessage && (
            ...
            <div
              className={`hive-login-error ${loginLocked
                  ? "login-lock-error"
                  : ""
                }`}
            >
...
================================================= */}
  ...
  ================================================= */}
            ...
            <button
              type="button"
              className="hive-social-button hive-apple-button"
              onClick={() =>
            ...
            >
              ...
              {socialLoading === "apple" ? (
                ...
                <span className="hive-real-apple-icon">
                  <svg
                    viewBox="0 0 24 24"
                    width="22"
                    height="22"
                  ...
                  >
                    <path
                      fill="currentColor"
                      d="M17.05 12.54c-.02-2.31 1.89-3.42 1.98-3.47a4.26 4.26 0 0 0-3.35-1.81c-1.41-.15-2.77.84-3.49.84-.73 0-1.85-.82-3.04-.8-1.56.02-3 .91-3.79 2.31-1.62 2.81-.41 6.95 1.15 9.22.76 1.11 1.67 2.35 2.86 2.3 1.15-.05 1.59-.74 2.99-.74 1.39 0 1.79.74 3 .72 1.24-.02 2.02-1.12 2.75-2.24a9.2 9.2 0 0 0 1.25-2.59 4.02 4.02 0 0 1-2.31-3.7z"
                    />

                    <path
                      fill="currentColor"
                      d="M14.72 5.68c.64-.78 1.07-1.87.95-2.95-.93.04-2.05.62-2.72 1.4-.6.68-1.12 1.78-.98 2.83 1.04.08 2.11-.53 2.75-1.28z"
                    />
                  </svg>
                </span>
